        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h2 className="text-lg font-semibold text-white">AuditHook</h2>
                <p className="text-xs">AI Smart Contract Auditor</p>
              </div>
            </div>
          </div>
          <div className="text-center md:text-right">
            <p className="text-sm">Built for DeFi Infrastructure</p>
            <p className="text-xs mt-1">Powered by Base & Uniswap v4</p>
          </div>
        </div>
      </div>
    </footer>
